...
export function Suggestion() {
    ...
    const [limitUsers, setLimitUsers] = useState(7)

    const slice = suggestions.slice(0, limitUsers)

    useEffect(() => {
        fetch(`https://api.github.com/users/GuiDEV1/followers`)
        .then((response) => {
    ...
    return (
        <div className="container-suggestion">
            <div className="header-suggestion" >
                <img src={`https://avatars.githubusercontent.com/u/100242616?v=4`} />

                <div className="user-infos-suggestion" >

                    <div className="infos" >
                        <span>guilherme.mascarenhas.7399</span>
                        <p>Guilherme Mascarenhas</p>
                    </div>
